...
public class InvoicesController : ControllerBase
{
    ...
    /// <summary>
    /// Exports an invoice to the requested format and initiates a file download.
    /// </summary>
    /// <param name="id">The unique identifier (GUID) of the invoice to download.</param>
    /// <param name="format">The desired file format (e.g., "pdf", "csv"). Defaults to "pdf".</param>
    /// <returns>
    /// A file stream result if found; otherwise, a 404 Not Found response.
    /// </returns>
    /// <response code="200">Returns the file stream for download.</response>
    /// <response code="404">If the invoice with the specified ID does not exist.</response>
    [HttpGet("{id}/download")]
